...
if (isset($_POST['simpan_absen_keluar'])) {
  simpan_absen_keluar();
}
...
<div class="row">
	<div class="col-sm-12">
        ...
        <form action="" method="POST">
          ...
          <tr>
            <td>
              <button type="submit" name="simpan_absen_keluar" class="btn btn-primary" 
               <?php echo val_absen_k(); ?>

              onclick="return confirm('ingin absen keluar?')">Absen Keluar
              </button>
            </td>
