			...
			<table class="table-responsive table-borderless table-earning">
				...
				<tbody>
					...
					<td>
						...
						<input type="text" name="jam_masuk" class="form-control" placeholder="Contoh : 0900" value="<?=$jammasuk['jam_masuk'];?>">
					</td>
					</tr>
			...
			<table class="table-responsive table-borderless table-earning">
				...
				<tbody>
					...
					<td>
						...
						<input type="text" name="jam" class="form-control" placeholder="Contoh : 0900" value="<?= $jamkeluar['jam'];?>">
					</td>
					</tr>
